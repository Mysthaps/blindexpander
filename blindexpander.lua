...
local BLINDEXPANDER_VERSION = 102090
	...
	function Game.update_new_round(self, dt)
		...
		then
			...
			then -- Triggers if blind is not the original blind
				...
				if
					G.GAME.blind.config.blind.phases
					and G.GAME.current_round.phases_beaten >= G.GAME.blind.config.blind.phases
				then
...
SMODS.current_mod.calculate = function(self, context)
	if context.end_of_round and not context.game_over and context.main_eval and G.GAME.blind.first_faced_blind then
