...
---@field modifies_draw? boolean Set to `true` to allow passives to modify the number of cards drawn to hand.
...
---@field blind_obj? table The base object for the Blind this passive is on